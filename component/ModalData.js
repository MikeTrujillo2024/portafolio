 const modalData = [
    {
        ...
        description: [
            ...
            "<li>HTML5: marcado semántico para una mejor estructura</li><li>CSS3: Esticlo avanzado mediante Flexbox, psoicionamiento</li><li>Metodologia BEM: Estandarizar la estructura de las clases para organizar los estilos de manera escalable</li><li>Contenndores para la integracion de elmentos muultimedia como youtube</li><li>GitHub: control de versiones del proyecto</li>",
    ...
    },
    {
        ...
        description: [
            ...
            "<li>HTML5</li><li>CSS3</li><li>JavaScript (ES6+)</li><li>Programación Orientada a Objetos (POO)</li><li>Metodología BEM</li><li>Webpack</li><li>Diseño Responsivo</li><li>Git y GitHub</li>",
    ...
    },
    {
        ...
        description: [
            ...
            "<li>HTML</li><li>CSS3</li><li>BEM</li><li>FIGMA</li><li>control de versiones GITHUB</li>",
